    ...
    private void showbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showbuttonActionPerformed
        ...
        for (int i = 0;i < rowsize;i++){
            if (jTable1.getValueAt(0,5).toString().trim().equals("thu")){
                sumthuthang -= Integer.parseInt(model.getValueAt(0,6).toString());
            } else {
                sumthuthang += Integer.parseInt(model.getValueAt(0,6).toString());
            }
            model.removeRow(0);
        ...
        for(int i = 0;i < list.size();i++){
            if(Integer.parseInt(monthdisplay.getText()) == list.get(i).thang && Integer.parseInt(yeardisplay.getText()) == list.get(i).nam){
                ...
                if (rowData[5].equals("thu")){
                    sumthuthang += list.get(i).value;
                } else {
                    sumthuthang -= list.get(i).value;
                }
                model.addRow(rowData);
                totalthudisplaymaster.setText(Integer.toString(sumthuthang));
            }
        }
