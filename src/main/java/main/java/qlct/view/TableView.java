...
public class TableView extends javax.swing.JFrame {
    ...
    public List<BangThuChi> tablethuchi;
    public List<BangThuChi> loaddata(){
        try {
            ...
            java.lang.reflect.Type typethuchi = new TypeToken<List<BangThuChi>>(){}.getType();
            tablethuchi = new Gson().fromJson(reader,typethuchi);
            reader.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try{
            if (Integer.parseInt(displaymonth.getText()) != NaN && Integer.parseInt(displayday.getText()) != NaN && Integer.parseInt(displayyear.getText()) != NaN && Integer.parseInt(displaymoney.getText()) != NaN){
                if (displaytype.getText().trim().equals("thu") || displaytype.getText().trim().equals("chi")){    
                    ...
                    writer.write(new Gson().toJson(tablethuchi));
                    writer.close();
                } else {
